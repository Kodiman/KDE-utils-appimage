...
-h|--help) echo "
 AVAILABLE KDE UTILITIES:
    ...
    telly-skout
";;
ark|filelight|francis|isoimagewriter|kalm|kate|kbackup|kcalc|kcharselect|kclock|kdebugsettings|kdf|kdialog|keditbookmarks|keysmith|kfind|kgpg|kongress|krecorder|kteatime|ktimer|ktrip|kweather|kwrite|skanpage|sweeper|telly-skout|kcron|dolphin|ksystemlog|partitionmanager)
_JUNEST_CMD -- "$@"
;;
*)
